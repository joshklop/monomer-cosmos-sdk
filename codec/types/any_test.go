...
// See https://github.com/joshklop/monomer-cosmos-sdk/issues/8537
func TestNewAnyWithCustomTypeURLWithErrorNoAllocation(t *testing.T) {
	// This tests continues to fail inconsistently.
	//
	// Example: https://github.com/joshklop/monomer-cosmos-sdk/pull/9246/checks?check_run_id=2643313958#step:6:118
	// Ref: https://github.com/joshklop/monomer-cosmos-sdk/issues/9010
	t.SkipNow()
