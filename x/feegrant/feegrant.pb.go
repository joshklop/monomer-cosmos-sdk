...
import (
	...
	types1 "github.com/joshklop/monomer-cosmos-sdk/codec/types"
...
type BasicAllowance struct {
	...
	SpendLimit github_com_cosmos_cosmos_sdk_types.Coins `protobuf:"bytes,1,rep,name=spend_limit,json=spendLimit,proto3,castrepeated=github.com/joshklop/monomer-cosmos-sdk/types.Coins" json:"spend_limit"`
...
type PeriodicAllowance struct {
	...
	// in the period
	PeriodSpendLimit github_com_cosmos_cosmos_sdk_types.Coins `protobuf:"bytes,3,rep,name=period_spend_limit,json=periodSpendLimit,proto3,castrepeated=github.com/joshklop/monomer-cosmos-sdk/types.Coins" json:"period_spend_limit"`
	// period_can_spend is the number of coins left to be spent before the period_reset time
	PeriodCanSpend github_com_cosmos_cosmos_sdk_types.Coins `protobuf:"bytes,4,rep,name=period_can_spend,json=periodCanSpend,proto3,castrepeated=github.com/joshklop/monomer-cosmos-sdk/types.Coins" json:"period_can_spend"`
